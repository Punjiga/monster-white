      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center mb-16">
           <div className="mb-10 md:mb-0 text-center md:text-left">
             <span className="font-display font-bold text-6xl text-black tracking-tighter">M</span>
           </div>
        ...
        <div className="border-t border-gray-200 pt-10">
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            <p className="text-center font-display text-xs text-black font-bold tracking-[0.2em] uppercase">
              Diseñado & Desarrollado con React + Tailwind. 2024.
            </p>
            <a 
